...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=1.0]{images/double-cycle-type2-small.png}
		\caption{}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=1.0]{images/cycle-types-small.png}
		\caption{}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[scale=1.0]{images/triple-cycle-types-small.png}
		\caption{}
